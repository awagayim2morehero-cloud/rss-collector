...
FEEDS = [
    ...
    # ⑤ AIエージェントセキュリティ（新規）
    {
        "name": "AIエージェントセキュリティ（英語）",
        "category": "研究会",
        "url": gnews('"agentic AI" security OR "prompt injection" agent OR "AI agent hijacking" OR "multi-agent" vulnerability enterprise 2025 OR 2026'),
        "filter": False,
    },
    {
        "name": "LLMエージェント攻撃・ガバナンスリスク",
        "category": "研究会",
        "url": gnews('"LLM agent" attack OR "autonomous agent" risk OR "code generation" security vulnerability governance 2025 OR 2026'),
        "filter": False,
    },
    {
        "name": "OWASP LLMセキュリティ",
        "category": "研究会",
        "url": gnews('OWASP "LLM security" OR "AI security" vulnerability agent 2025 OR 2026'),
        "filter": False,
    },
    {
        "name": "NIST AI Risk Management",
        "category": "研究会",
        "url": gnews('NIST "AI Risk Management" OR AIRMF agent security governance audit 2025 OR 2026'),
        "filter": False,
    },
    {
        "name": "DeepMind Safety Research",
        "category": "研究会",
        "url": gnews('"Google DeepMind" safety research alignment agent risk 2025 OR 2026'),
        "filter": False,
    },
    {
        "name": "AIエージェントセキュリティ（日本語）",
        "category": "研究会",
        "url": gnews('AIエージェント 脆弱性 OR プロンプト注入 OR ジェイルブレイク OR 乗っ取り 監査 OR ガバナンス', lang="ja"),
        "filter": False,
    },
...
①監査品質・オペレーション: AI監査、調書作成AI、職業的懐疑心、自動化バイアス、ISA500、不正リスク、ハルシネーション、監査品質、Continuous Audit、AIエージェント攻撃・脆弱性（プロンプト注入・ジェイルブレイク）の監査実務影響、コード自動生成AIの監査品質リスク
...
⑤リスクマネジメント: 期待ギャップ、注意義務、AIリスク、データセキュリティ、監査責任、当局検査、AIエージェントセキュリティリスク、マルチエージェントシステムの予期しない動作・相互作用リスク、エージェント乗っ取り・プロンプト注入の企業ガバナンスへの影響
該当領域がない場合は "" を返す。
...
◆ ①⑤領域かつAIエージェントセキュリティを扱う場合（プロンプト注入・マルチエージェントリスク・エージェント乗っ取り・コード生成脆弱性等）:
5: 監査法人・規制当局（IAASB/IIA/PCAOB/NIST/EU等）が直接言及するAIエージェントセキュリティリスク
4: エンタープライズ規模でのAIエージェント導入に伴うセキュリティ・ガバナンスの課題
3: 一般的なAIセキュリティ事例で監査プロフェッション・企業ガバナンスへの示唆が読み取れるもの
2以下: 特定製品・サービスのセキュリティ情報のみで監査プロフェッションへの接続が薄いもの
...
ただし、AIエージェントへの攻撃事例（プロンプト注入・ジェイルブレイク・エージェント乗っ取り・マルチエージェントシステム脆弱性等）であって、監査実務・ガバナンス保証・リスク管理への示唆が読み取れるものはこの制限を適用しない。
